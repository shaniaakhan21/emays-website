...
export const config = {
    ...
    LETS_TALK_EMAIL: LETS_TALK_EMAIL || 'chathuranga.dyrani@gmail.com',
    RECAPTCHA_PROJECT_ID: RECAPTCHA_PROJECT_ID || 'emays-1683534163102',
    RECAPTCHA_SITE_KEY: RECAPTCHA_SITE_KEY || '6LeZUe8lAAAAALuM_bjvYMlBanNAeG_s4lulVkT_',
    RECAPTCHA_SECRET: RECAPTCHA_SECRET || '6LeZUe8lAAAAADjDkLOZEEi4cBWmpIwl7oxaBZ_n'
};
