...
import { allowedForClientRoleAndSuperAdminAndAdminOnly } from '../middleware/paramValidationMiddleware';
...
router.get(RoutePath.APP_INFO, allowedForClientRoleAndSuperAdminAndAdminOnly, (req: express.Request, res: express.Response): void => {
