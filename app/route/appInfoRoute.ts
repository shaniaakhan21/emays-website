...
import { allowedForExternalSystemSuperUserAndAdminAndManagerAndDriverClientRolesOnly } from '../middleware/paramValidationMiddleware';
...
router.get(RoutePath.APP_INFO, allowedForExternalSystemSuperUserAndAdminAndManagerAndDriverClientRolesOnly, (req: express.Request, res: express.Response): void => {
